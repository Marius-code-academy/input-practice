...
// * A submit button
// Use JavaScript to retrieve the values of the form elements when the submit button is clicked. When the submit button is clicked, display an alert message with the selected foods in a list format, e.g. "You selected pizza, pasta, broccoli, and apple."
